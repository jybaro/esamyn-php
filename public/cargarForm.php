...
function p_guardar_preguntas($hijos, $padre = null) {
    ...
    if(empty($hijos)) {
        ...
        foreach($hijos as $hijo){
            ...
            $sql = "INSERT INTO esamyn.esa_pregunta(prg_formulario, prg_padre, prg_texto, prg_orden, prg_tipo_pregunta) VALUES ($frm_id, $padre, $texto, ".($count*100).", $sql_tipo_pregunta) RETURNING prg_id";
            //echo "<pre>$sql</pre>";
            $result = pg_query($sql);
